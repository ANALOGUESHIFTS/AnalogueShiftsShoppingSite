  ...
  return (
    ...
    >
      ...
      <p className="text-PrimaryBlack/60 font-semibold text-base leading-7">
        We are a home-grown, independent social enterprise with focus on
        fashion, lifestyle and culture. We offer new and exciting ways to
        ...
        meaningful, the relationships between people and the clothes that matter
        to them.
      </p>
      ...
      <p className="text-PrimaryBlack/60 font-semibold text-base leading-7">
        Cinnamon19fashion.com is a virtual concept store with a high level of
        interest in Nigerian fashion brands. The platform features products and
        content that seeks to build a community of confident, self-aware and
        self-expressive individuals. We offer an international standard shopping
