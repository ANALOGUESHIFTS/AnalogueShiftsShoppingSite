...
export default function BespokeModal({ close }) {
  ...
  const detailScreen = (
    <div className="w-full relative h-full bg-white p-5">
      ...
      <div className="flex justify-between pb-4 pt-2 border-b">
        <p className="text-PrimaryOrange tracking-wider font-semibold text-xs flex items-center">
      ...
      <div className="w-full py-4 overflow-y-scroll h-[350px] px-3">
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen bg-black/25 flex justify-center items-center">
      <div className="w-[600px] h-[500px] overflow-hidden rounded-xl">
        {element}
      </div>
    </div>
  );
